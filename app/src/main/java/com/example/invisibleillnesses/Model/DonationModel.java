...
public class DonationModel {
    ...
    public DonationModel(String id, String first_name, String last_name, String street_name, String apartment_status, String suburb_value, String post_code, String phone_value, String email_address, String donation_price) {
        this.id = id;
