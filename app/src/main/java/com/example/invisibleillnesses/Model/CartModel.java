...
public class CartModel implements Parcelable {
    ...
    public CartModel(String id, String product_id, String product_name, String product_price, String product_designer, String product_view_size, String product_view_refund, String product_weekend, String product_view_short_des, String product_view_des, String product_view_image, String user_id, String user_email, String product_choose_date) {
        this.id = id;
